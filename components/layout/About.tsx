...
export default function About() {
	return (
		...
		>
			<section
				id="about"
				className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-linear-to-l from-[#d1c3b5] to-[#ffff] px-15 py-10"
			>
				<div className="">
					<div className="flex flex-col">
						<p className="text-sm tracking-widest">SOBRE NÓS</p>
						<h1 className="text-center md:text-start text-4xl md:text-5xl font-bold mt-4 mb-6">
							Paixão por
						...
						<p className="text-center md:text-start text-[#b08a69] mb-6 text-lg">
						...
						<p className="text-center md:text-start text-[#b08a69] mb-8">
				...
				<motion.div
					...
					className="hidden md:flex justify-center rounded-4xl items-center bg-[#7e553c]"
				>
